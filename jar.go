...
type Storage interface {
	Get(id string, key string) map[string]Entry
	Set(id string, key string, cookies map[string]Entry)
}
...
type Options struct {
	...
	// Email or any other reference possible
	Id string
